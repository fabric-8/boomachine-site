...
(function(){
  ...
  function buzzLetter(){
    ...
    el.classList.remove("is-buzz");
    void el.offsetWidth;                      /* restart the animation */
    el.classList.add("is-buzz");
    timers.push(setTimeout(function(){ el.classList.remove("is-buzz"); }, 340));
  }
  ...
  function stop(){
    ...
    letters.forEach(function(el){ el.classList.remove("is-dim"); el.classList.remove("is-buzz"); });
  }
  ...
  function holdOn(v){
    if(v){ title.classList.add("is-flick"); root.classList.add("t-flick"); root.classList.add("rl-flare"); if(letters[4]) letters[4].classList.add("is-dim"); }
    else { title.classList.remove("is-flick"); root.classList.remove("t-flick"); root.classList.remove("rl-flare"); letters.forEach(function(el){ el.classList.remove("is-dim"); }); }
  }
