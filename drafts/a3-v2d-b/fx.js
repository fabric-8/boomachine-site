/* =========================================================================
   ...
   1. THE TITLE'S REFLECTION  (.d-refl, one canvas per .lbox)
      ...
      blurred 6 px, tinted amber and faded with distance from the mirror line.
...
(function (global) {
  ...
  function drawRefl() {
    ...
    g.addColorStop(0, "#FFC781");           /* top of the sign  */
    g.addColorStop(0.62, "#FFB347");
    g.addColorStop(1, "#E08A1E");           /* bottom, nearer the mirror */
    s.fillStyle = g;
  ...
  function seed(p, first) {
    ...
    p.k = Math.random() < 0.34 ? 1 : 0;          /* amber vs red dust */
    return p;
  }
  ...
  function sizeMotes() {
    ...
    halo = haloBox();
    if (!halo) return;
    if (!sprites) sprites = [sprite(255, "146,118"), sprite(255, "198,140")];
